...
public interface SequenceEditor {
	...
	/**
	 * Applies the transformation to the given image. Landmarks 
	 * can be null, if {@link SequenceEditor#inputsLandmarks()
	 * inputsLandmarks()} returns false.
	 * 
	 * @param image the image to edit
	 * @param landmarks the landmarks associated with the image
	 */
